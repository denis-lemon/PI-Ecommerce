...
public class ProductResource {
    ...
    */
    ...
    public ModelAndView novoProduto() {
        ModelAndView np = new ModelAndView();
        np.setViewName("/product/novo-produto");
        return np;
    }
  ...
  /*
    ...
    @PostMapping("/salvar")
    public ModelAndView salvarProduto(Product product) {
        ModelAndView mv = new ModelAndView();
        productRepository.save(product);
        mv.setViewName("redirect:/products/lista");
        return mv;
    }
	...
	public String editarProduct(@PathVariable("id") long id, Model model) {
	    ...
	    return "/product/alterar-produto";
	}
	...
	public String editarProduct(@PathVariable("id") long id, 
	    ...
	    productRepository.save(product);
	    return "redirect:/product/lista-produtos";
	}
